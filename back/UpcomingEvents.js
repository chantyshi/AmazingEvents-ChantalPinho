const data = {
  ...
  function pintarTarjetas(arregloAPintar, divContenedor){
  ...
  function crearTarjeta(divContenedor, contenidoTarjeta){
    ...
    `
    padreTarjetas.appendChild(contenidoDeTarjetaNueva)
    console.log(contenidoDeTarjetaNueva);
  }
  ...
  for (let i = 0; i < data.events.length; i++){
    if(data.currentDate < data.events[i].date){
        arreglosFuturos.push(data.events[i])
    
    }
  }


  pintarTarjetas(arreglosFuturos, padreTarjetas)
